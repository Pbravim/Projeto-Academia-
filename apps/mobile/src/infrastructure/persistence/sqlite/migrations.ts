 ...
 *
 * Shared by the production migration runner (ExpoSQLiteDatabaseClient) and the
 * test database factory (src/test/db-setup.ts) so both execute migrations with
 * identical semantics (per-statement, swallowing only "duplicate column name").
 *
