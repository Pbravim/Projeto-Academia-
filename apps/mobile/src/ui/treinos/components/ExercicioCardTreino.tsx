...
function makeStyles(c: ReturnType<typeof useTheme>) {
  return StyleSheet.create({
    ...
    ordem: { color: c.accentInk, fontSize: 14, fontWeight: '800', minWidth: 16 },
    nameBlock: { flex: 1 },
    ...
    vincularBtnText: { color: c.accentInk, fontSize: 12, fontWeight: '700' },
    ...
    addSubstitutoBtnText: { color: c.accentInk, fontSize: 16, fontWeight: '800' },
