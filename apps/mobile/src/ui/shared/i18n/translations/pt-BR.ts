export const ptBR = {
  ...
  treinos: {
    ...
    list: {
      ...
      importarTreino: 'Importar treino',
      nameLabel: 'Nome',
    ...
    importar: {
      titulo: 'Importar treino',
      colarLabel: 'Cole o JSON do treino',
      colarPlaceholder: 'Cole aqui o conteúdo do arquivo .json...',
      escolherArquivo: 'Escolher arquivo',
      analisar: 'Analisar',
      analisando: 'Analisando...',
      revisaoTitulo: 'Revisão da importação',
      casado: 'Encontrado no catálogo',
      naoCasado: 'Não encontrado',
      escolherNoCatalogo: 'Escolher no catálogo',
      trocar: 'Trocar',
    ...
    exportar: {
      botao: 'Exportar',
      exportando: 'Exportando...',
      erro: 'Não foi possível exportar o treino.',
    },
  },
  exercises: {
    errors: {
