export const enUS = {
  ...
  sessao: {
    ...
    substituir: {
      title: 'Swap exercise',
      buscar: 'Search by name, muscle group or equipment',
      ...
      semResultado: 'No exercise found for this search.',
  ...
  treinos: {
    ...
    importar: {
      titulo: 'Import workout',
      colarLabel: 'Paste the workout JSON',
      colarPlaceholder: 'Paste the .json file content here...',
      escolherArquivo: 'Choose file',
      analisar: 'Analyze',
      analisando: 'Analyzing...',
      revisaoTitulo: 'Import review',
      casado: 'Found in the catalog',
      naoCasado: 'Not found',
      escolherNoCatalogo: 'Choose from catalog',
      trocar: 'Change',
      ...
      erros: {
        ...
        exercicio_repetido: 'The exercise "%{nome}" appears more than once. Adjust it before saving.',
      },
      custom: {
        titulo: 'Create custom exercise',
        nomeLabel: 'Name',
        grupoLabel: 'Muscle group',
    ...
    exportar: {
      botao: 'Export',
      exportando: 'Exporting...',
      erro: 'Could not export the workout.',
    },
  },
  exercises: {
    errors: {
