...
function makeStyles(c: ReturnType<typeof useTheme>) {
  return StyleSheet.create({
    ...
    sectionLabelPredefinido: { color: c.accentInk },
    ...
    candidatoNomeSelected: { color: c.accentInk },
    candidatoMeta: { color: c.textSecondary, fontSize: 12 },
    candidatoUltimo: { color: c.accentInk, fontSize: 12, fontWeight: '600' },
    checkmark: { color: c.accentInk, fontSize: 18, fontWeight: '800', marginLeft: 8 },
