...
function makeStyles(c: ReturnType<typeof useTheme>) {
  return StyleSheet.create({
    ...
    backBtn: { padding: 6 },
    backBtnText: { color: c.accentInk, fontSize: 20, fontWeight: '700', lineHeight: 22 },
    headerMeta: { flex: 1, gap: 2 },
    headerTitle: { color: c.textPrimary, fontSize: 15, fontWeight: '800' },
    headerSubtitle: { color: c.textSecondary, fontSize: 12 },
    substituicaoBadge: { color: c.accentInk, fontSize: 11, fontWeight: '600' },
    ...
    substituirBtnText: { color: c.accentInk, fontSize: 11, fontWeight: '700' },
    ...
    mediaToggleBtnIcon: { color: c.accentInk, fontSize: 12, fontWeight: '800' },
    mediaToggleBtnText: { color: c.accentInk, fontSize: 13, fontWeight: '700' },
    ...
    mediaInlineBtnIcon: { color: c.accentInk, fontSize: 10, fontWeight: '800' },
    mediaInlineBtnText: { color: c.accentInk, fontSize: 11, fontWeight: '700' },
    ...
    sugestaoText: { color: c.accentInk, fontSize: 13, fontWeight: '700' },
    ...
    serieValueBest: { color: c.accentInk },
    serieUnit: { color: c.textSecondary, fontSize: 11, fontWeight: '600' },
    serieBestStar: { color: c.accentInk, fontSize: 14, fontWeight: '800' },
    ...
    serieLabelBest: { color: c.accentInk, fontWeight: '800' },
    ...
    modeToggleText: { color: c.accentInk, fontSize: 12, fontWeight: '700' },
    ...
    navegacaoBtnTextProximo: { color: c.accentInk },
