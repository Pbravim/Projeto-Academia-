...
function makeStyles(c: ReturnType<typeof useTheme>) {
  return StyleSheet.create({
    ...
    sugestaoLabel: { color: c.accentInk, fontSize: 11, fontWeight: '800', textTransform: 'uppercase', letterSpacing: 0.8 },
    ...
    livreBtnText: { color: c.accentInk, fontSize: 14, fontWeight: '800' },
