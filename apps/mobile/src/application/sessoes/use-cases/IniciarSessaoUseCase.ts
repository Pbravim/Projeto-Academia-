    ...
    const saveAll = async () => {
      ...
      for (const { p, ex } of exerciseSnapshots) {
        const sessaoExercicio = SessaoExercicio.create({
          ...
          movementPatternSnapshot: ex.movementPattern,
          realizado: false,
          ...
          metodo: p.metodo,
          grupoId: p.grupoId,
          trackingTypeSnapshot: ex.trackingType,
          duracaoRecomendadaSegundos: p.duracaoRecomendadaSegundos ?? null,
          distanciaRecomendadaMetros: p.distanciaRecomendadaMetros ?? null,
          intensidadeRecomendada: p.intensidadeRecomendada ?? null,
