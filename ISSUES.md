# Issues — Projeto Academia

## Concluídos

- [x] Melhorar a escolha de temas
- [x] Os exercícios só estão representando um grupo muscular mesmo quando fazem parte de vários
- [x] Quando abre uma série finalizada a visualização é estranha — pensar numa versão melhor ou nem abrir
- [x] Trocar o ícone de substituição de exercício
- [x] Erro de estado com a sessão — investigar
- [X] Não faz sentido a opção de iniciar sessão se o treino escolhido não tem exercício cadastrado
